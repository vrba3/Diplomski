...
@Component({
  selector: 'app-car-profile-by-searched-cars-from-logged-users',
  templateUrl: './car-profile-by-searched-cars-from-logged-users.component.html',
  styleUrls: ['./car-profile-by-searched-cars-from-logged-users.component.css']
})
export class CarProfileBySearchedCarsFromLoggedUsersComponent implements OnInit {
  car: Car;
  carImg: String;
  numOfImg: number;
  user: User;
